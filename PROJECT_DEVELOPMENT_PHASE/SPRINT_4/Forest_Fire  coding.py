...
def run_inference_for_single_image(image, graph):
    ...
    if ((output_dict['detection_classes'][0] == 1 or output_dict['detection_scores'][0] < 0.70) and (output_dict['detection_classes'][0] == 2 or  output_dict['detection_scores'][0] < 0.70)):
      print('No Fire')
